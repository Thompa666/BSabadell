...
public class ImageLoader extends com.android.volley.toolbox.ImageLoader {
    ...
    public ImageLoader(FragmentActivity activity, int defaultPlaceHolderResId) {
        super(Volley.newRequestQueue(activity),
    ...
    public void getBitmap(String requestUrl, ImageListener listener) {
        getBitmap(requestUrl, listener, mMaxImageWidth, mMaxImageHeight);
    }

    public void getBitmap(String requestUrl, ImageListener listener, int width, int height) {
        get(requestUrl, listener, width, height);
    }
