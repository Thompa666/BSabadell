...
public class FinancialProductModel extends BaseProductModel implements Parcelable {
    ...
    private FinancialProductModel(Parcel in) {
    ...
    public static final Creator<FinancialProductModel> CREATOR = new Creator<FinancialProductModel>() {
        public FinancialProductModel createFromParcel(Parcel source) {
            return new FinancialProductModel(source);
        }

        public FinancialProductModel[] newArray(int size) {
            return new FinancialProductModel[size];
        }
    };
}
